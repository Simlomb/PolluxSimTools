...
specs = {'ctts': {'desc': 'Classical T-Tauri Star', 
         ...
         'gdwarf': {'desc': 'G Dwarf', 
                    ...
                    'band': 'galex,fuv'},
         'alpcmi': {'desc': 'F5IV-V', 
                    'file': [data_base, 'h_alp-cmi_uvsum_1x_52720-55864_etc.dat.txt'],
                    'band': 'galex,fuv'},
         'alplyr': {'desc': 'A0V', 
                    'file': [data_base, 'h_alp-lyr_uvsum_1h_56227-56717_etc.dat.txt'],
                    'band': 'galex,fuv'},
         'gamdra': {'desc': 'K5III', 
                    'file': [data_base, 'h_gam-dra_uvsum_1x_55783-55836_etc.dat.txt'],
                    'band': 'galex,fuv'},
         'hr1886': {'desc': 'B1V', 
                    'file': [data_base, 'h_hr-1886_uvsum_1x_52955-56934_etc.dat.txt'],
                    'band': 'galex,fuv'},
