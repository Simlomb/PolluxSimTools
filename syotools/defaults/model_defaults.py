...
if use_pathlib:
    ...
    #polimage_default_path = str(Path('data') / 'POLUX_map.pickle')
    ...
    #polimage_default_path = os.path.join(current_dir, '..', 'data', 'POLUX_map.pickle')
...
#default_spectropolarimeterimage = OrderedDict([("_lumos_default_file", polimage_default_path)])
#default_spectropolarimeter.update(all_defaults['SpectropolarimeterImage'])
